...
interpreter = tf.lite.Interpreter(
    ...
    model_path="models/best-fp16.tflite")  # centernet_512x512 works correctly
...
image = cv2.imread("F:/repos/TensorFlow/workspace/training_demo/res/images/train/00002.jpg")
